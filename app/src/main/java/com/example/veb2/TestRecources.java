...
public class TestRecources extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_recources);
        String profileName = "@Boris";
        setTitle("Профиль пользователя" + profileName);
        Button buttonSub = findViewById(R.id.subscribeButton);
        ...
        mainLayout = findViewById(R.id.mainLayoutXML);
